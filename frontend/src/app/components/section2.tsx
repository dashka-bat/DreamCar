    ...
    <div className="w-full flex justify-center items-center flex-col mt-15">
      ...
      {data.map((item) => (
        ...
        >
          ...
          <h2 className="text-xl font-bold mt-4 text-[#b19155]">{item.name}</h2>
          <h3 className="text-[#b19155]">{item.description}</h3>

          {/* Carousel эхэлж байна */}
          {item.img.length > 0 && (
            <Carousel className="mt-4 w-full h-[200px] rounded-lg">
              <CarouselContent>
              ...
              <div className="flex justify-between mt-2">
                <CarouselPrevious className="bg-[#b19155] text-black px-3 py-1 rounded">
                  Өмнөх
                </CarouselPrevious>
                <CarouselNext className="bg-[#b19155] text-black px-3 py-1 rounded">
                  Дараах
                </CarouselNext>
              </div>
            </Carousel>
