      ...
      <div className="w-[375px]">
        ...
        <div className="bg-black  min-h-screen">
              ...
              {winner?.winnerImgs?.map((img: string, idx: number) => (
                <button
                  ...
                  className={`border rounded-md overflow-hidden ${
                    selectedImage === img ? "ring-2 ring-[#b19155]" : ""
                  }`}
                >
                  <img
                    src={img}
          ...
          <div className="mt-5 w-[90%] border-b-[#b19155] border-b-1 ml-4">
            <h1 className="text-[#b19155] font-extrabold text-xl ml-3 pb-3 ">
              {winner?.winners[0]?.name}
            </h1>
          </div>
          <div className="ml-4 mt-3">
            <h1 className="text-[#b19155] font-extrabold text-[16px] ml-5 pb-3">
              Азтан болсон сугалааны дугаар: {winner?.winners[0]?.ticketNumber}
            </h1>
          </div>
          <div className="ml-4 mt-3">
            <h1 className="text-[#b19155] font-extrabold text-[16px] ml-5 pb-3">
              Утасны дугаар: {winner?.winners[0]?.phoneNumber}
            </h1>
          </div>
          ...
          <div className="mt-5 w-[90%]  ml-4">
            <div className="text-[#b19155] font-extrabold text-[16px] ml-5 pb-3">
              ...
              <br></br>
              <br></br>
              Сугалаа бүтээлцсэн та бүхэндээ талархая дараагийн машин таных
              болог
            </div>
          </div>
          <div className="mt-5 w-[90%]  ml-4">
            <h1 className="text-[#b19155] font-extrabold text-xl ml-3 pb-3">
              Тохирлын шууд бичлэг:
            </h1>
          </div>
          ...
          <div className="w-[80%] flex gap-12 text-[#b19155] border-t-[#b19155] border-t-1 mt-20 ml-10">
            <a>
              <FaInstagram className="text-[#b19155] w-12 h-12 mt-10" />
            </a>
            <FaFacebook
              href="https://www.facebook.com/profile.php?id=100087912670023"
              className="text-[#b19155] w-12 h-12 mt-10"
            />
            <FaTwitter className="text-[#b19155] w-12 h-12 mt-10" />
            <FaPhoneAlt className="text-[#b19155] w-12 h-12 mt-10 cursor-pointer" />
          </div>
        </div>
      </div>
    </div>
